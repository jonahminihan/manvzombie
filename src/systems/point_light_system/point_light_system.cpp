...
namespace mvz {
    ...
    PointLightSystem::PointLightSystem(MvzDevice &device, VkRenderPass renderPass,
                                       VkDescriptorSetLayout globalSetLayout) : mvzDevice{device} {
    ...
    void PointLightSystem::createPipeline(VkRenderPass renderPass) {
        ...
        MvzPipeline::enableAlphaBlending(pipelineConfig);
        pipelineConfig.attributeDescriptions.clear();
        pipelineConfig.bindingDescriptions.clear();
        pipelineConfig.renderPass = renderPass;
        pipelineConfig.pipelineLayout = pipelineLayout;
        mvzPipeline = std::make_unique<MvzPipeline>(mvzDevice,
    ...
    void PointLightSystem::render(FrameInfo &frameInfo) {
        std::map<float, MvzGameObject::id_t> sorted;
        for (auto &kv: frameInfo.gameObjects) {
            auto &obj = kv.second;
            if (obj.pointLight == nullptr) continue;
